...
public class OrderLine extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -1572044172154130757L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"OrderLine\",\"namespace\":\"com.trivadis.kafka.poc.avro.v1\",\"fields\":[{\"name\":\"lineId\",\"type\":\"long\"},{\"name\":\"productId\",\"type\":\"long\"},{\"name\":\"quantity\",\"type\":\"int\"}]}");
   ...
   */
  public OrderLine(java.lang.Long lineId, java.lang.Long productId, java.lang.Integer quantity) {
    this.lineId = lineId;
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: lineId = (java.lang.Long)value$; break;
   ...
   */
  public static com.trivadis.kafka.poc.avro.v1.OrderLine.Builder newBuilder() {
    return new com.trivadis.kafka.poc.avro.v1.OrderLine.Builder();
  }
   ...
   * @return A new OrderLine RecordBuilder
   */
  public static com.trivadis.kafka.poc.avro.v1.OrderLine.Builder newBuilder(com.trivadis.kafka.poc.avro.v1.OrderLine.Builder other) {
    if (other == null) {
      return new com.trivadis.kafka.poc.avro.v1.OrderLine.Builder();
    } else {
      return new com.trivadis.kafka.poc.avro.v1.OrderLine.Builder(other);
    }
  }
   ...
   * @return A new OrderLine RecordBuilder
   */
  public static com.trivadis.kafka.poc.avro.v1.OrderLine.Builder newBuilder(com.trivadis.kafka.poc.avro.v1.OrderLine other) {
    if (other == null) {
      return new com.trivadis.kafka.poc.avro.v1.OrderLine.Builder();
    } else {
      return new com.trivadis.kafka.poc.avro.v1.OrderLine.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<OrderLine>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.trivadis.kafka.poc.avro.v1.OrderLine.Builder other) {
      super(other);
      if (isValidValue(fields()[0], other.lineId)) {
        this.lineId = data().deepCopy(fields()[0].schema(), other.lineId);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.trivadis.kafka.poc.avro.v1.OrderLine other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.lineId)) {
        this.lineId = data().deepCopy(fields()[0].schema(), other.lineId);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.trivadis.kafka.poc.avro.v1.OrderLine.Builder setLineId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.trivadis.kafka.poc.avro.v1.OrderLine.Builder clearLineId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.trivadis.kafka.poc.avro.v1.OrderLine.Builder setProductId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.trivadis.kafka.poc.avro.v1.OrderLine.Builder clearProductId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.trivadis.kafka.poc.avro.v1.OrderLine.Builder setQuantity(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.trivadis.kafka.poc.avro.v1.OrderLine.Builder clearQuantity() {
    ...
    public OrderLine build() {
      try {
        ...
        record.lineId = fieldSetFlags()[0] ? this.lineId : (java.lang.Long) defaultValue(fields()[0]);
